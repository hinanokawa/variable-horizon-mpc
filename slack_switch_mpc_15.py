...
axs[0].set_ylabel("h (Water level)")
axs[0].set_title("State Response (Water Level)")
axs[0].legend()
axs[0].grid(True)
...
axs[1].set_ylabel("u (Control input)")
...
axs[2].set_ylabel("Prediction Horizon N")
...
axs[3].set_title("Prediction Error Indicator (EMA)")
axs[3].legend()
axs[3].grid(True)
